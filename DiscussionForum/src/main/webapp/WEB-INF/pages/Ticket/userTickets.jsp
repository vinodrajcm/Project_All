...
<script
	src="${pageContext.request.contextPath}/resources/js/resource/jquery.dataTables.min.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/resource/dataTables.bootstrap4.min.js"></script>
<link rel="stylesheet"
...
<body>
	...
	<div class="title">
		Ticket List
		<div id="logout" class="logout" style="float: right;">
			<a href="../ticketUpdate/logout" style="color: #ecce5e;">logout</a>
		</div>
	</div>
	...
	<table id="userList" class="table display responsive "
		...
		<thead>
			<tr class="tr-head">
				...
				<th>Status</th>
				<th>Created Date<br>(Y-M-D)
				</th>
				<th>Start Date<br>(Y-M-D)
				</th>
				<th>End Date<br>(Y-M-D)
				</th>
				<th>Effort <br>(In Days)
				</th>
				<!-- <th>Edit BY</th> -->
		...
		<tbody>
			<c:forEach var="TicketsData" items="${result}">
				<tr class="tr-header">
					...
					<td id="ticketCreatedDate">${TicketsData.ticketCratedDate}</td>
			...
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Update No of
						hours Spent on ticket day wise from start date to end date</h5>
		...
		$(document)
				.ready(
						function() {
							...
							$("#ticketCreatedDate").change(function() {
