...
<div class="container">
<div class="headerTitle">Edit Form</div>
...
<div class="col-sm-4">
 <div class="form-group">
   ...
   <div data-tip="Enter only Alphanumeric with out space">
    <input type="text" class="form-control" id="firstName" name="firstName" placeholder="Enter First Name" value="${editUser.firstName}">
 </div>   
  ...
  <div class="form-group">
    ...
    <div data-tip="Enter only Alphanumeric with out space">
    <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Enter Last Name" value="${editUser.lastName}">
    </div>
  </div>
  <div class="form-group">
    <label for="loginId">Login ID</label>
    <div data-tip="Enter only Alphanumeric with out space">
    <input type="text" class="form-control" id="login_Id" name="loginId" placeholder="Enter Login ID" value="${editUser.loginId}" >
    </div>
    
     <label for="loginId">user ID</label>
    <div data-tip="Enter only Alphanumeric with out space">
    <input type="text" class="form-control" id="user_Id" name="userId" placeholder="Enter Login ID" value="${editUser.userId}">
    </div>
  </div>
  <div class="form-group">
    <label for="password">Password</label>
    <div data-tip="Enter [7 to 15 characters which contain at least one numeric digit and a special character]">
    <input type="text" class="form-control" name="password" id="password_id" placeholder="Enter Password" value="${editUser.password}">
    </div>
  </div>
...
<div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1"  name="email" aria-describedby="emailHelp" placeholder="Enter email" value="${editUser.email}">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <button type="submit" class="btn btn-kenna" style="width: 100%;margin-top: 2em;">Update</button>
  </div> 
 </div> 
</form>   
